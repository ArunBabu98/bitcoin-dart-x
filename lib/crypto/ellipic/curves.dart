...
class SelectCurve {
  /// P curves
  late final EllipticCurve _p128 = EllipticCurve(
  ...
  late final EllipticCurve _p224 = EllipticCurve(
  ...
  late final EllipticCurve _p256 = EllipticCurve(
    'secp256r1',
    256,
    BigInt.parse(
  ...
  late final EllipticCurve _p384 = EllipticCurve(
    'secp384r1',
    384,
    BigInt.parse(
  ...
  final Curve _p521 = EllipticCurve(
    'secp521r1',
    521,
    BigInt.parse(
  ...
  /// S curves
  late final EllipticCurve _s224 = EllipticCurve(
    'secp224k1',
    224,
  ...
  late final EllipticCurve _s256 = EllipticCurve(
    'secp256k1',
    256,
    BigInt.parse(
